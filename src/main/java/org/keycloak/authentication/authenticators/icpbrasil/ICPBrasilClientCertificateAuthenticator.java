 ...
 * @date 8/9/2017
 */
public class ICPBrasilClientCertificateAuthenticator extends AbstractICPBrasilClientCertificateAuthenticator {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        try {
            ...
            if (certs == null || certs.length == 0) {
                ...
                logger.debug("[ICPBrasilClientCertificateAuthenticator:authenticate] x509 client certificate is not available for mutual SSL.");
                context.attempted();
                return;
            }
            ...
            if (config == null) {
                logger.warn("[ICPBrasilClientCertificateAuthenticator:authenticate] x509 Client Certificate Authentication configuration is not available.");
            ...
            if (userIdentity == null) {
                ...
                logger.warnf("[ICPBrasilClientCertificateAuthenticator:authenticate] Unable to extract user identity from certificate.");
                // TODO use specific locale to load error messages
            ...
            logger.errorf("[ICPBrasilClientCertificateAuthenticator:authenticate] Exception: %s", e.getMessage());
            context.attempted();
        }
    }
    ...
    private Response createResponse(AuthenticationFlowContext context,
        ...
        return form
                ...
                .createForm("login-icpbrasil-info.ftl");
    }
